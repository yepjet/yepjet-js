...
var _Travelers = require('./resources/Travelers');

var _Travelers2 = _interopRequireDefault(_Travelers);
...
var YepJet = (function () {
  function YepJet() {
    ...
    var host = arguments.length <= 1 || arguments[1] === undefined ? 'sandbox.yepjet.com' : arguments[1];
    ...
    this.travelers = Object.freeze(new _Travelers2.default(props));
